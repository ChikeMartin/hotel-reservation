...
public class MainMenu {
        ...
        while (!isReserved) {
            ...
            switch (option){
                case 1:
                    ...
                    break;    //TODO This portion might have to be changed to 'continue' (below) once actual accounts are being returned
                case 2:
                    // enter new dates
                    continue;
                case 3:
    ...
    private static Collection<IRoom> findARoom() {
        ...
        do {
            ...
            try {
                do {
                    System.out.println("Enter check in date in the format dd-mm-yyyy: ");
                    checkIn= scanner.next();
                    setCheckInDate(new SimpleDateFormat(dateFormatString).parse(checkIn));
                ...
                do {
                    System.out.println("Enter check out date in the format dd-mm-yyyy: ");
                    checkOut= scanner.next();
                    setCheckOutDate(new SimpleDateFormat(dateFormatString).parse(checkOut));
